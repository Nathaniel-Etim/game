...
var secnumber = Math.trunc(Math.random() * 20) + 1;
var newscore = Number(document.querySelector(".score"));
...
document.querySelector(".check").addEventListener("click", function () {
  ...
  if (!guess) {
    ...
    document.querySelector(".between").innerHTML = " you guessed the correct score "; // number.style.fontSize = `80px`;
